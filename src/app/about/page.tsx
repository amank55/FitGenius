      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <p className="mb-6">
              Whether you&rsquo;re just starting your fitness journey or you&rsquo;re looking to take your training to the next level, FitGenius is here to help. Join our community of fitness enthusiasts and start your journey to a healthier, stronger you today.
            </p>
